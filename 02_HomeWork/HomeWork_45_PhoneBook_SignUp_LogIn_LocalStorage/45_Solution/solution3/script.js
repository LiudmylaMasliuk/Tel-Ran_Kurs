...
function renderLogin(){
    ...
    <form name = "loginForm" action="#">
       ...
       />
       <div class="buttons">
       <button id="registration-btn">sign up</button>
       <button id="login-btn" class="add-btn">log in</button>
       </div>
     </form>
    `;
}
...
function loginSubmitHandler(event){
    ...
    if(user.email === '' || user.password === ''){
        ...
        showError('The data is incomplete');
    }else{
        ...
        if(event.submitter.id === 'registration-btn'){
            try{
