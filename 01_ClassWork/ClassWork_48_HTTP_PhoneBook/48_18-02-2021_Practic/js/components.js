...
function content(contacts,selectedIndex,mode,onContactClickHandler,onAddContactClickHandler,onDeleteContactClickHandler){
  const div = document.createElement('div');
  ...
  <div class="header">
    ...
    div.onclick = event => {
      ...
      if(event.target.classList.contains('delete')){
        onDeleteContactClickHandler(contact);
      }
    }
    return div;
}
